...
func (app *App) handleCustomRSSPost(w http.ResponseWriter, r *http.Request) {
	log.Printf("handleCustomRSSPost called, method: %s", r.Method)
	...
	log.Printf("Config JSON length: %d", len(configJSON))

	if configJSON == "" {
		log.Printf("Config is empty")
